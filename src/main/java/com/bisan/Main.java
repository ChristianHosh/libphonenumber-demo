...
public class Main {
  ...
  public static void parse(String[] args, int index) throws NumberParseException {
    String number = args[0];
    String countryCode = args[args.length - 1];

    if (countryCode.equals(number)) {
      // no country code use 'IL' (System Default)
      countryCode = "IL";
    }
    ...
    try {
      ...
      System.out.println("is valid number:\t\t\t" + PHONE_NUMBER_UTIL.isValidNumber(phoneNumber));
